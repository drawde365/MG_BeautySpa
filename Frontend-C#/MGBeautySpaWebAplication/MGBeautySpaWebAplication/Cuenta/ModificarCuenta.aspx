<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ModificarCuenta.aspx.cs" Inherits="MGBeautySpaWebAplication.Cuenta.ModificarCuenta" %>
<!DOCTYPE html>
<html lang="es">
<head runat="server">
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <title>Editar Cuenta | MG Beauty Spa</title>
            ...
            <div class="page-container">
                <main class="content-wrapper">
                    ...
                    <div class="title-container">
                        <h1 class="title-text">Edita tu cuenta</h1>
                    </div>
