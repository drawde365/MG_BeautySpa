...
namespace SoftInvBusiness.SoftInvWSHorarioTrabajo {
    ...
    public interface HorarioTrabajo {
        ...
        SoftInvBusiness.SoftInvWSHorarioTrabajo.InsertarHorarioTrabajoPorPartesResponse InsertarHorarioTrabajoPorPartes(SoftInvBusiness.SoftInvWSHorarioTrabajo.InsertarHorarioTrabajoPorPartesRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://softinvws.services.softinv.pucp.edu.pe/HorarioTrabajo/InsertarHorarioTraba" +
            "joPorPartesRequest", ReplyAction="http://softinvws.services.softinv.pucp.edu.pe/HorarioTrabajo/InsertarHorarioTraba" +
            "joPorPartesResponse")]
        System.Threading.Tasks.Task<SoftInvBusiness.SoftInvWSHorarioTrabajo.InsertarHorarioTrabajoPorPartesResponse> InsertarHorarioTrabajoPorPartesAsync(SoftInvBusiness.SoftInvWSHorarioTrabajo.InsertarHorarioTrabajoPorPartesRequest request);
    ...
    public partial class InsertarHorarioTrabajoPorPartesRequest {
        ...
        public InsertarHorarioTrabajoPorPartesRequest(int idEmpleado, int diaSemana, string horaInicio, string horaFin) {
    ...
    public partial class HorarioTrabajoClient : System.ServiceModel.ClientBase<SoftInvBusiness.SoftInvWSHorarioTrabajo.HorarioTrabajo>, SoftInvBusiness.SoftInvWSHorarioTrabajo.HorarioTrabajo {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        SoftInvBusiness.SoftInvWSHorarioTrabajo.InsertarHorarioTrabajoPorPartesResponse SoftInvBusiness.SoftInvWSHorarioTrabajo.HorarioTrabajo.InsertarHorarioTrabajoPorPartes(SoftInvBusiness.SoftInvWSHorarioTrabajo.InsertarHorarioTrabajoPorPartesRequest request) {
            return base.Channel.InsertarHorarioTrabajoPorPartes(request);
        }
        
        public int InsertarHorarioTrabajoPorPartes(int idEmpleado, int diaSemana, string horaInicio, string horaFin) {
            SoftInvBusiness.SoftInvWSHorarioTrabajo.InsertarHorarioTrabajoPorPartesRequest inValue = new SoftInvBusiness.SoftInvWSHorarioTrabajo.InsertarHorarioTrabajoPorPartesRequest();
            inValue.idEmpleado = idEmpleado;
            inValue.diaSemana = diaSemana;
            inValue.horaInicio = horaInicio;
            inValue.horaFin = horaFin;
            SoftInvBusiness.SoftInvWSHorarioTrabajo.InsertarHorarioTrabajoPorPartesResponse retVal = ((SoftInvBusiness.SoftInvWSHorarioTrabajo.HorarioTrabajo)(this)).InsertarHorarioTrabajoPorPartes(inValue);
            return retVal.@return;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<SoftInvBusiness.SoftInvWSHorarioTrabajo.InsertarHorarioTrabajoPorPartesResponse> SoftInvBusiness.SoftInvWSHorarioTrabajo.HorarioTrabajo.InsertarHorarioTrabajoPorPartesAsync(SoftInvBusiness.SoftInvWSHorarioTrabajo.InsertarHorarioTrabajoPorPartesRequest request) {
            return base.Channel.InsertarHorarioTrabajoPorPartesAsync(request);
        }
        
        public System.Threading.Tasks.Task<SoftInvBusiness.SoftInvWSHorarioTrabajo.InsertarHorarioTrabajoPorPartesResponse> InsertarHorarioTrabajoPorPartesAsync(int idEmpleado, int diaSemana, string horaInicio, string horaFin) {
            SoftInvBusiness.SoftInvWSHorarioTrabajo.InsertarHorarioTrabajoPorPartesRequest inValue = new SoftInvBusiness.SoftInvWSHorarioTrabajo.InsertarHorarioTrabajoPorPartesRequest();
            inValue.idEmpleado = idEmpleado;
            inValue.diaSemana = diaSemana;
            inValue.horaInicio = horaInicio;
            inValue.horaFin = horaFin;
            return ((SoftInvBusiness.SoftInvWSHorarioTrabajo.HorarioTrabajo)(this)).InsertarHorarioTrabajoPorPartesAsync(inValue);
        }
        ...
        public SoftInvBusiness.SoftInvWSHorarioTrabajo.horarioTrabajoDTO ObtenerHorarioTrabajoPorId(int empleadoId, int diaSemana) {
        ...
        public System.Threading.Tasks.Task<SoftInvBusiness.SoftInvWSHorarioTrabajo.ObtenerHorarioTrabajoPorIdResponse> ObtenerHorarioTrabajoPorIdAsync(int empleadoId, int diaSemana) {
            SoftInvBusiness.SoftInvWSHorarioTrabajo.ObtenerHorarioTrabajoPorIdRequest inValue = new SoftInvBusiness.SoftInvWSHorarioTrabajo.ObtenerHorarioTrabajoPorIdRequest();
            inValue.empleadoId = empleadoId;
            inValue.diaSemana = diaSemana;
