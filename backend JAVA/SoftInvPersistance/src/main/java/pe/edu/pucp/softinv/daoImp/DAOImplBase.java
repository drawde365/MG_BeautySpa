...
public abstract class DAOImplBase {
    ...
    Boolean dejarConexionAbierta;

    protected Boolean getDejarConexionAbierta() {
        return dejarConexionAbierta;
    }

    protected void setDejarConexionAbierta(Boolean dejarConexionAbierta) {
        this.dejarConexionAbierta = dejarConexionAbierta;
    }
